...
public class VmTest5 {
    public static void main(String[] args) throws Exception {
        String testContractPath = "F:\\workSpace2026\\blockchain\\solana_java\\src\\test\\java\\com\\bit\\solana\\vmt\\com\\bit\\solana\\vmt\\PropertyMortgageLoanContract.class"; // 替换为实际路径
        // 1. 读取并压缩class文件
